        ...
        public static ModelBuilder PropertyForSaleBuilder(ModelBuilder builder)
        {
            builder.Entity<PropertyForSale>().HasData(
                new PropertyForSale
                {
                    ...
                    ImageUrls = new List<string>() { "~/api/Pictures/image1.jpg", "~/api/Pictures/image2.jpg" }
                },
                 new PropertyForSale
                 {
                     PropertyForSaleId = 2,
                     ...
                     NumberOfRooms = 1,
                     TypeOfProperty = TypeOfPropertyEnum.Bostadsrättslägenhet,
                     ImageUrls = new List<string>() { "~/api/Pictures/image3.jpg", "~/api/Pictures/image4.jpg" }
                 },
                 new PropertyForSale
                 {
                     PropertyForSaleId = 3,
                     ...
                     ImageUrls = new List<string>() { "~/api/Pictures/image5.jpg", "~/api/Pictures/image6.jpg" }
                 }
                );
            return builder;
        }
