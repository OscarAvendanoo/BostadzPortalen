...
{
    /// <inheritdoc />
    public partial class jn5 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "87efc5ac-77d8-4729-b3d6-3309dc88e88d", 0, 2, "c224b729-8062-4bbe-8f63-c3e7cc4da00c", "Realtor", "realtor@demoapi.com", true, "System", "Realtor", false, null, "REALTOR@DEMOAPI.COM", "REALTOR@DEMOAPI.COM", "AQAAAAIAAYagAAAAEL87EmIBCRbHOsT0qvbNg/9MNm09Vja3Peood/GldOu7o0XusLZEzuRP/BoOvyO2cw==", "0722661922", false, "NoPicUser.png", "8c842b2f-fab8-4d76-bff6-d1f7f6dac1a9", false, "realtor@demoapi.com" },
                    { "92b88e50-795f-4df6-90e0-8a7d9a179cb0", 0, 1, "c7db965f-6bec-4fda-baa4-339d42f7ff4a", "Realtor", "user@demoapi.com", true, "System", "User", false, null, "USER@DEMOAPI.COM", "USER@DEMOAPI.COM", "AQAAAAIAAYagAAAAEDM5VD/KVSKLksU3ZrC5m4BDWHWT4xWvWrPO+6M0CJtCodth3Tzp0KO4geYw5R9QDg==", "0722661922", false, "NoPicUser.png", "023de4e3-0a1a-4e0d-a981-15649e815cb7", false, "user@demoapi.com" },
                    { "92d637e6-6a8d-421e-a118-7a29d0edc1e7", 0, 1, "82eb8030-d8f4-46ab-b0bf-00185d5fb598", "Realtor", "admin@demoapi.com", true, "System", "Admin", false, null, "ADMIN@DEMOAPI.COM", "ADMIN@DEMOAPI.COM", "AQAAAAIAAYagAAAAEAc70M4x3y77QSnEc6KVIMQjJD4SYoEZ5z1benantBycwoSoYxzgeOhu4MGuy7FW2g==", "0722661920", false, "NoPicUser.png", "33e20125-868b-437f-9e2a-4c827a0575b0", false, "admin@demoapi.com" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Wanker Street 69", 500000m, "It's a place to live", "[\"~/api/Pictures/image1.jpg\",\"~/api/Pictures/image2.jpg\"]", 24, 5000m, 1, 1, 8, "92b88e50-795f-4df6-90e0-8a7d9a179cb0", 8, 0, 1999, 1000m },
                    { 2, "Kungsgatan 4", 1000000m, "Fin utsikt", "[\"~/api/Pictures/image3.jpg\",\"~/api/Pictures/image4.jpg\"]", 24, 10000m, 2, 1, 8, "87efc5ac-77d8-4729-b3d6-3309dc88e88d", 8, 0, 1999, 1000m },
                    { 3, "Kungsgatan 16", 7000000m, "Bättre än kungsgatan 4", "[\"~/api/Pictures/image5.jpg\",\"~/api/Pictures/image6.jpg\"]", 64, 10000m, 2, 4, 8, "87efc5ac-77d8-4729-b3d6-3309dc88e88d", 8, 2, 1950, 1000m }
                });
